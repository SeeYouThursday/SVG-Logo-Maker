...
describe("Shape", () => {
  ...
  //Testing for setFill to throw an error if not a valid color
  describe("setFill method test", () => {
    test("should return an error if not a valid color", () => {
      const shape = new Shape();
      shape.setFill("Bluey");
      expect(shape.setFill("Bluey")).toEqual(
