  ...
  describe("Checking for Text", () => {
    test("Render text html", () => {
      ...
      expect(shape.renderText()).toEqual(
        `<text x="150" y="125" font-size="60" text-anchor="middle" fill="blue">URM</text>`
      );
    });
  });
...
describe("Triangle Tests", () => {
  ...
  describe("Full SVG Rendering", () => {
    it("Triangle should return full svg html", () => {
      ...
      shape.textColor = "red";
      expect(shape.htmlRender()).toEqual(
        `<?xml version="1.0" encoding="utf-8"?><svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150, 18 244, 182 56, 182" fill="blue" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="red">URM</text></svg>`
      );
    });
  });
});
...
describe("Square Tests", () => {
  ...
  describe("Full SVG Rendering", () => {
    it("Square should return full svg html", () => {
      ...
      shape.textColor = "red";
      expect(shape.htmlRender()).toEqual(
        `<?xml version="1.0" encoding="utf-8"?><svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="50" y="20" width="160" height="160" style="fill:blue;" /><text x="150" y="125" font-size="60" text-anchor="middle" fill="red">URM</text></svg>`
      );
    });
  });
});
